library(readr)
export_table_tra <- read_csv("G:/Programming/R_VIS/preprocessing/export_table_TE.csv")
tbl_subj_id <- read.csv("G:/Programming/R_VIS/preprocessing/export_table_subjects.csv", header = TRUE, sep = ";")
tbl_subj_beh <- read.csv("G:/Programming/R_VIS/preprocessing/behavioral_data_20201120.csv", header = TRUE, sep = ";")


# lege die Inputtable fest
tbl_inp <- export_table_coh
tbl_inp <- export_table_tra
